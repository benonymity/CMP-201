...
// This project kinda snowballed into a fun weekend project that's doubling as
// my CS homework. I used inheritance on the shape classes, and plenty of
// polymorphism with virtual functions and overloaded operators, so it should
// count! There are still plenty of bugs with this project, mostly to do with
// the imprecision of floats eventually resulting in physics issues (e.g.
// phasing through walls/shapes/etc). Not sure what the elegant solution to that
// is, though there probably is one. I used a nice open-source, single-file
// graphics library to interface with OpenGL (https://github.com/erkkah/tigr),
// but otherwise wrote this all by hand. I mostly used Randy Gaul's physics
// simlulation blog posts to learn about the logic behind physics simulation,
// but didn't just copy and paste and tried to understand all the reasoning
// behind everything.
//
...
// https://ericleong.me/research/circle-circle/, https://randygaul.github.io/)
//
// If you want to compile and run this yourself, you shouldn't need to install
// anything, but you will need to compile with the C++17 standard, because this
// uses the algorithims package added in that version of the STD. On MacOS I can
// compile with
//
// g++ -std=c++17 5.2.cpp tigr.c -o physics -framework OpenGL -framework Cocoa
//
// But if you're on windows, you should be able to compile with
//
// g++ -std=c++17 5.2.cpp tigr.c -o physics -s -lopengl32 -lgdi32
//
// Enjoy!
...
class Circle : public Shape {
  public:
    ...
    void handleCollision(Circle& other) {
        ...
        float e = 0.8; // Resistution coefficient
